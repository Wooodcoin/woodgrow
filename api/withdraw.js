...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Безпечно обнуляємо баланс у Firebase після успішного виведення
        await fetch(`${FIREBASE_BASE_URL}/users/${userId}/balance.json`, { method: 'PUT', body: JSON.stringify(0) });
